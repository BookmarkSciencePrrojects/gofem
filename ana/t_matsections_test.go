...
func Test_sections01(tst *testing.T) {
	...
	chk.Scalar(tst, "rect: Irr", 1e-17, rect.Irr, 72.0)
	chk.Scalar(tst, "rect: Iss", 1e-17, rect.Iss, 32.0)
	...
	chk.Scalar(tst, "rect: Irr", 1e-13, rect.Irr, 21.3333333333333)
	chk.Scalar(tst, "rect: Iss", 1e-13, rect.Iss, 21.3333333333333)
	...
	chk.Scalar(tst, "I-beam: Irr", 1e-10, ibeam.Irr, 33.4583333333)
	chk.Scalar(tst, "I-beam: Iss", 1e-10, ibeam.Iss, 5.3445833333)
	...
	chk.Scalar(tst, "circle: Irr", 1e-10, circle.Irr, 0.7853981634)
	chk.Scalar(tst, "circle: Iss", 1e-10, circle.Iss, 0.7853981634)
