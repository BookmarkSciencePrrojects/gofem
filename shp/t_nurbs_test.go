...
func Test_nurbs01(tst *testing.T) {
	...
	io.Pforan("0: u = %v\n", shape0.U)
	chk.Float64(tst, "0: ux", 1e-17, shape0.U[0], (1.0+r[0])*dux/drx)
	chk.Float64(tst, "0: uy", 1e-17, shape0.U[1], (1.0+r[1])*duy/dry)
	...
	io.Pfpink("\n1: u = %v\n", shape1.U)
	chk.Float64(tst, "1: ux", 1e-17, shape1.U[0], 0.5+(1.0+r[0])*dux/drx)
	chk.Float64(tst, "1: uy", 1e-17, shape1.U[1], (1.0+r[1])*duy/dry)
