...
func Test_sg52b(tst *testing.T) {
	...
	tolu := 1e-17
	tols := 1.56e-15
	TestingCompareResultsU(tst, "data/sg52.sim", "cmp/sg52.cmp", "", tolK, tolu, tols, skipK, chk.Verbose, nil)
}
...
func Test_sg57(tst *testing.T) {
	...
	tolu := 2e-9
	tols := 0.0002
	TestingCompareResultsU(tst, "data/sg57.sim", "cmp/sg57.cmp", "", tolK, tolu, tols, skipK, chk.Verbose, nil)
}
...
func Test_sg511(tst *testing.T) {
	...
	tolu := 3e-14
	tols := 1.56e-7
	TestingCompareResultsU(tst, "data/sg511.sim", "cmp/sg511.cmp", "", tolK, tolu, tols, skipK, chk.Verbose, nil)
}
...
func Test_sg515(tst *testing.T) {
	...
	if true {
		...
		tolu := 3e-13
		tols := 3e-8
		TestingCompareResultsU(tst, "data/sg515.sim", "cmp/sg515.cmp", "", tolK, tolu, tols, skipK, chk.Verbose, nil)
	}
}
...
func Test_sg527(tst *testing.T) {
	...
	if true {
		...
		tolu := 3e-13
		tols := 5e-8
		TestingCompareResultsU(tst, "data/sg527.sim", "cmp/sg527.cmp", "", tolK, tolu, tols, skipK, chk.Verbose, nil)
	}
}
...
func Test_sg517(tst *testing.T) {
	...
	tolu := 1e-6
	tols := 1e-4
	TestingCompareResultsU(tst, "data/sg517.sim", "cmp/sg517.cmp", "", tolK, tolu, tols, skipK, chk.Verbose, nil)
}
...
func Test_sg524(tst *testing.T) {
	...
	tolu := 1e-8
	tols := 1e-7
	TestingCompareResultsU(tst, "data/sg524.sim", "cmp/sg524.cmp", "", tolK, tolu, tols, skipK, chk.Verbose, nil)
}
...
func Test_sg530(tst *testing.T) {
	...
	tolu := 1e-17
	tols := 1e-15
	TestingCompareResultsU(tst, "data/sg530.sim", "cmp/sg530.cmp", "", tolK, tolu, tols, skipK, chk.Verbose, nil)
}
...
func Test_sg422(tst *testing.T) {
	...
	tolu := 1e-17
	tols := 1e-15
	TestingCompareResultsU(tst, "data/sg422.sim", "cmp/sg422.cmp", "", tolK, tolu, tols, skipK, chk.Verbose, nil)
}
