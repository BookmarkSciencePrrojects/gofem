...
func PlotAllBendingMom2d(dom *Domain, nstations int, withtext bool, numfmt string, tolM, coef, sf float64) (beams []*solid.Beam, allMrr [][]float64) {

	// collect beams
	for _, elem := range dom.Elems {
		if beam, ok := elem.(*solid.Beam); ok {
