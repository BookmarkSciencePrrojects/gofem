...
func init() {
	...
	infogetters["rjoint"] = func(sim *inp.Simulation, cell *inp.Cell, edat *inp.ElemData) *Info {
		return &Info{}
	}

	// element allocator
	eallocators["rjoint"] = func(sim *inp.Simulation, cell *inp.Cell, edat *inp.ElemData, x [][]float64) Elem {
		var o Rjoint
		o.Sim = sim
		o.Edat = edat
		o.Cell = cell
...
func (o *Rjoint) InterpStarVars(sol *Solution) (err error) {
	return
}
...
func (o *Rjoint) Ureset(sol *Solution) (err error) {
	return
}
