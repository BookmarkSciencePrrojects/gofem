...
func Test_fourlayers01(tst *testing.T) {
	...
	//Verbose()
	chk.PrintTitle("fourlayers01. Setting up of multi-layered problems")

	main := fem.NewMain("data/fourlayers.sim", "", true, false, false, false, chk.Verbose, 0)

	doms := fem.NewDomains(main.Sim, main.DynCfs, 0, 1, false, false)
	if len(doms) == 0 {
